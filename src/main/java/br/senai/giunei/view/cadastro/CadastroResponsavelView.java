...
public class CadastroResponsavelView extends JPanel {
	...
	public CadastroResponsavelView(String titulo, Usuario logado) {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				usuario.setPerfil(Perfil.RESPONSAVEL);
				...
				if (usuario.getId() != null) {
					...
					JOptionPane.showMessageDialog(null, "Responsável salvo");
				}
				limparCampos();
				carregarTabela();
			}
		...
		JLabel lblNewLabel_2_1 = new JLabel("Lista de Respons\u00E1veis");
	...
	private void carregarTabela() {
		usuarios = new UsuarioDAO().buscar(Perfil.RESPONSAVEL);
