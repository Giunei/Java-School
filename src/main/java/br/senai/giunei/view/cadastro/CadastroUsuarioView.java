...
public class CadastroUsuarioView extends JPanel {
	...
	private JComboBox perfilCB;
	
	private Usuario usuario = new Usuario();
	private List<Usuario> usuarios = new ArrayList<Usuario>();

	public CadastroUsuarioView(String titulo, Usuario logado) {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Perfil perfil = Perfil.values()[perfilCB.getSelectedIndex()];
		...
		JLabel lblNewLabel_1_1_1_2 = new JLabel("PERFIL:");
		...
		gbc_lblNewLabel_1_1_1_2.insets = new Insets(0, 0, 0, 5);
		gbc_lblNewLabel_1_1_1_2.gridx = 2;
		gbc_lblNewLabel_1_1_1_2.gridy = 6;
		panel_2.add(lblNewLabel_1_1_1_2, gbc_lblNewLabel_1_1_1_2);
		
		perfilCB = new JComboBox();
		perfilCB.setModel(new DefaultComboBoxModel(new String[] {"Administrador", "Diretor", "Secretaria", "Professor", "Aluno", "Respons\u00E1vel"}));
		perfilCB.setFont(new Font("Dialog", Font.BOLD, 16));
		GridBagConstraints gbc_perfilCB = new GridBagConstraints();
		gbc_perfilCB.fill = GridBagConstraints.HORIZONTAL;
		gbc_perfilCB.gridx = 3;
		gbc_perfilCB.gridy = 6;
		panel_2.add(perfilCB, gbc_perfilCB);
		...
		JLabel lblNewLabel_2_1 = new JLabel("Lista de Usuarios");
		...
		btnEditar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (table.getSelectedRow() >= 0) {
					...
					perfilCB.setSelectedIndex(usuario.getPerfil().ordinal());
